...
import { ENKIEM_STAGE_1 } from "../constants/enkiem/enkiem-stage-1";
import { ENKIEM_STAGE_2 } from "../constants/enkiem/enkiem-stage-2";
import { ENKIEM_STAGE_3 } from "../constants/enkiem/enkiem-stage-3";

export const FightWithEnkiem = () => {
    return (
        <Fragment>
