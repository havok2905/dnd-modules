...
const Creatures = ()=> {
    return (
        <Page>
            ...
            <CollapsableContainer title="Mage of the Dragon's Flame" idSlug='mage-of-the-dragons-flame'>
                <MonsterBlock {...MAGE_OF_THE_DRAGONS_FLAME}/>
            </CollapsableContainer>
            <CollapsableContainer title="Pirate of the Dragon's Flame" idSlug='pirate-of-the-dragons-flame'>
                <MonsterBlock {...PIRATE_OF_THE_DRAGONS_FLAME}/>
            </CollapsableContainer>
            <CollapsableContainer title="Sloan's Elite Guard" idSlug='sloans-elite-guard'>
